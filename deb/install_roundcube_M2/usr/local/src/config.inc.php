...
$config['plugins'] =  array('mel_logs','mel', 'mel_contacts', 'mel_larry', 'mel_courrielleur', 'mel_acl', 'mel_sondage', 'mel_labels_sync','jqueryui', 'libcalendaring', 'calendar','tasklist','mel_moncompte','right_panel');
